...
@section('content')
<div class="row">
    <div class="col-sm-8"><h2>States</h2></div>
    <div class="col-sm-4 text-right"><a href="{{ route('state.add') }}" class="btn btn-success">Add State</a></div>
</div>
...
<script>
    $('document').ready(function(){
        formHelper.getIndex('{{ route('api.state.index') }}');
    });
</script>
@endsection
