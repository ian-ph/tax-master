...
@section('content')
<div class="row">
    <div class="col-sm-8"><h2>Countries</h2></div>
    <div class="col-sm-4 text-right"><a href="{{ route('country.add') }}" class="btn btn-success">Add Country</a></div>
</div>
...
<div class="card">
    <div class="card-body p-0">
        ...
        <div class="table-data d-none" data-edit_route="{{ route('country.edit', '') }}" data-delete_route="{{ route('country.delete', '') }}">
...
<script>
    $('document').ready(function(){
        formHelper.getIndex('{{ route('api.country.index') }}');
    });
</script>
@endsection
